...
import hu.webuni.hr.Jozsi.dto.View;
...
//			if(full == null || !full) {
//				return companies.values().stream().map(this::mapCompanyWithoutEmployees).collect(Collectors.toList());
//					
//		} else {
...
//	}
  ...
  @GetMapping("/{id}")
   ...
   @PutMapping("/{id}")
     public ResponseEntity<CompanyDto> modiflyCompany(@PathVariable long id, @RequestBody CompanyDto companyDto) {
